...
with(data3, plot(timedate, Global_active_power, type="n", xlab = "", ylab = "Global Active Power (kilowatts)"))
with(data3, lines(timedate, Global_active_power))
...
with(data3, plot(timedate, Voltage, type="l"))

with(data3, plot(timedate, Global_reactive_power, type="l"))
